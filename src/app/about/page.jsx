      ...
      <section className="md:w-8xl lg:w-7xl  mt-5 items-center p-8 mx-auto space-y-6  mb-16">
        ...
        <section>
          <div >
            ...
            <ul>
              <li className="text-base text-black mt-4 text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg  font-bold  text-center text-yellow-900 '>Premium Raw Nut Sourcing :</span> Hand‑picked nuts sourced directly from trusted farms, sun‑dried for freshness and spoilage prevention.</li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Precision Nut Calibration :</span>Nuts sorted by size (18mm–24mm) for efficient shelling and minimal kernel breakage. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Hygienic Nut Cleaning :</span> Foreign matter removed with sieves and manual sorting to ensure purity and safe processing.</li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Flavorful Nut Roasting :</span>Heat‑treated to enhance taste, brittle shells ease extraction, and natural oils are preserved. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Natural Nut Cooling :</span>Roasted nuts cooled gradually to maintain texture, prevent scorching, and prepare for shelling. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Efficient Nut Shelling :</span>Kernels extracted manually or mechanically for clean, whole cashew kernels. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Pure Kernel Separation :</span>Advanced blowers and shakers ensure maximum yield and shell‑free kernels. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Smart Kernel Pre‑grading :</span>Initial sorting improves efficiency and reduces grading workload. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Moisture‑Controlled Drying :</span>Kernels dried to safe levels (3–6%) for longer shelf life and pest resistance. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Smooth Kernel Peeling :</span>Testa removed for blanched, premium‑quality kernels with improved appearance. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>International Kernel Grading :</span>Kernels sorted by W180, W240, splits, and other global export standards. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Kernel Rehumidification :</span>Moisture adjusted to reduce breakage during transport and maintain quality. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Gourmet Nut Flavoring :</span>Salted, spiced, honey‑coated, or chocolate‑dipped for diverse consumer preferences. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Rigorous Quality Testing :</span>Chemical, hardness, and dimensional checks ensure safety and consistency. </li>
              <li className="text-base text-black text-left leading-relaxed max-w-8xl mx-auto "> <span className=' text-lg font-bold  text-center text-yellow-900 '>Freshness‑Preserving Packaging :</span>Sealed in pouches, jars, or tins to retain flavor, protect from contaminants, and inform consumers. </li>
            </ul>
          </div>
        </section>
