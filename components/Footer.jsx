      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><a href="/food-ingredients" className="hover:text-white transition">Food Ingredient</a></li>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-gray-300">
            <h2 className="hover:text-white transition">Classic Salted Makhana</h2>
            <h2 className="hover:text-white transition">Modern Savory Flavors makhana</h2>
            <h2 className="hover:text-white transition">Sweet Gourmet Flavors makhana</h2>
            <h2 className="hover:text-white transition">Fusion Spicy makhana</h2>
            <h2 className="hover:text-white transition">Whey Protein</h2>
          </div>
        </div>
