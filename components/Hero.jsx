            ...
            <div className="w-full max-w-360 mx-auto px-5  pt-32 md:pt-20 pb-20 h-full flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 w-full flex flex-col">
                ...
                <div className="flex items-center gap-4 mb-4 md:mb-10">
                  <Link href="/products">
                    <button className="bg-linear-to-r cursor-pointer from-amber-600 to-amber-300 text-[12px] lg:text-lg text-white px-3 py-1 lg:px-5 lg:py-2.5 rounded-xl transition hover:scale-105">
                      Explore Products
                    </button>
                  </Link>
                  <Link href="/contact">
                    <button className="border-2 border-black lg:text-lg cursor-pointer text-gray-900 text-[12px] px-2 py-1 lg:px-5 lg:py-2.5 rounded-xl transition hover:bg-black hover:text-white hover:scale-105">
                      Contact us
                    </button>
                  </Link>
                </div>
